...
let p1 = Presentation(slides: [p1s1, p1s2, p1s3, p1s4])
...
let p2 = Presentation(slides: [p2s1, p2s2, p2s3, p2s4])
...
let p3 = Presentation(slides: [p3s1, p3s2, p3s3, p3s4])
...
let p4 = Presentation(slides: [p4s1, p4s2, p4s3, p4s4])
...
let p5 = Presentation(slides: [p5s1, p5s2, p5s3, p5s4])
...
let p6 = Presentation(slides: [p6s1, p6s2, p6s3, p6s4])
...
let p7 = Presentation(slides: [p7s1, p7s2, p7s3, p7s4])
...
let p8 = Presentation(slides: [p8s1, p8s2, p8s3, p8s4])
...
let p9 = Presentation(slides: [p9s1, p9s2, p9s3, p9s4])
...
let p10 = Presentation(slides: [p10s1, p10s2, p10s3, p10s4])
...
let p11 = Presentation(slides: [p11s1, p11s2, p11s3, p11s4, p11s5])
...
let p12 = Presentation(slides: [p12s1, p12s2, p12s3, p12s4, p12s5])
...
let p13 = Presentation(slides: [p13s1, p13s2, p13s3, p13s4, p13s5, p13s6])
...
let p14 = Presentation(slides: [p14s1, p14s2, p14s3, p14s4, p14s5])
...
let p15 = Presentation(slides: [p15s1, p15s2, p15s3, p15s4, p15s5, p15s6])
...
let p16 = Presentation(slides: [p16s1, p16s2, p16s3, p16s4, p16s5])
...
let p17 = Presentation(slides: [p17s1, p17s2, p17s3, p17s4, p17s5, p17s6])
...
let p18 = Presentation(slides: [p18s1, p18s2, p18s3, p18s4, p18s5, p18s6])
...
let p19 = Presentation(slides: [p19s1, p19s2, p19s3, p19s4, p19s5])
...
let p20 = Presentation(slides: [p20s1, p20s2, p20s3, p20s4, p20s5])
